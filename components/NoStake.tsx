        ...
        <div>
          <div className="verticalalign" style={{justifyContent: "center",verticalAlign:"middle",textAlign:"center",alignItems:"center"}}>
            <div>
                ...
                <h1 style={{fontFamily:"Oswald",fontSize:"200%",textTransform:"uppercase",fontWeight:"bolder"}}>No Wolves Staked</h1>
                <br/>
                <a href="https://tensor.trade" className="utilitybutton2">BUY A WOLF</a>
                </div>
            </div>
       </div>
    )
